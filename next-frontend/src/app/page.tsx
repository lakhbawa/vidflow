  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white px-6 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16 pt-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <a href="https://github.com/lakhbawa/vidflow" target="_blank" rel="noopener noreferrer">
              <button
                className="border-2 border-gray-700 hover:border-gray-500 hover:bg-gray-800/50 px-8 py-4 rounded-xl font-medium transition-all backdrop-blur-sm flex items-center gap-2"
              >
          ...
          <div className="flex justify-center gap-4 text-sm text-gray-400">
            <a href="https://www.linkedin.com/in/lakhbawa/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition flex items-center gap-1">
            ...
            <a href="https://lakhveerbawa.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition flex items-center gap-1">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-gray-700 transition-all">
            ...
            <h3 className="text-xl font-semibold mb-2">Containerized Deployment</h3>
            <p className="text-gray-400 text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-gray-700 rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-gray-400">Coming Soon</h3>
                  <p className="text-gray-500 text-sm">
                    • Video aspect ratio conversion (9:16, 1:1)<br/>
      ...
      <footer className="text-center text-xs text-gray-500 z-10 relative pt-8 pb-4">
        © {new Date().getFullYear()} Vidflow — Built by <a href="https://lakhveerbawa.com/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transition">Lakhveer Bawa</a>
      </footer>
    </main>
  );
}
